...
//
//     it(
//       'should parse a response with cutoff repos and cutoff repos count',
//       () => {
//         const result = parseResponse(controllerRepository, {
//           workflow_run_id: 123,
//           repositories_queried: ['a/b', 'c/d'],
...
//
//     it(
//       'should parse a response with cutoff repos count but not cutoff repos',
//       () => {
//         const result = parseResponse(controllerRepository, {
//           workflow_run_id: 123,
//           repositories_queried: ['a/b', 'c/d'],
...
//
//     it(
//       'should parse a response with invalid repos and repos w/o databases',
//       () => {
//         const result = parseResponse(controllerRepository, {
//           workflow_run_id: 123,
//           repositories_queried: ['a/b', 'c/d'],
...
//
//     it(
//       'should parse a response with one repo of each category, and not pluralize "repositories"',
//       () => {
//         const result = parseResponse(controllerRepository, {
//           workflow_run_id: 123,

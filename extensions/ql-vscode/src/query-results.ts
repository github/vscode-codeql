...
export class CompletedQueryInfo implements QueryWithResults {
  ...
  /**
   * Note that in the {@link deserialize} method, we create a CompletedQueryInfo instance
...
export class LocalQueryInfo {
  ...
  /**
   * Note that in the {@link deserialize} method, we create a FullQueryInfo instance
   * by explicitly setting the prototype in order to avoid calling this constructor.
   */
  constructor(

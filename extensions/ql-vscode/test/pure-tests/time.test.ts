...
describe('Time', () => {
  it('should return a humanized unit', () => {
    expect(humanizeUnit(undefined)).toBe('Less than a minute');
    expect(humanizeUnit(0)).toBe('Less than a minute');
    expect(humanizeUnit(-1)).toBe('Less than a minute');
    expect(humanizeUnit(1000 * 60 - 1)).toBe('Less than a minute');
  ...
  it('should return a humanized duration positive', () => {
    ...
    expect(humanizeRelativeTime(1000 * 60 * 60 * 24 * 30 * 2)).toBe('in 2 months');
    expect(humanizeRelativeTime(1000 * 60 * 60 * 24 * 30 * 12)).toBe('in 12 months');

    // assume every year has 365 days
    expect(humanizeRelativeTime(1000 * 60 * 60 * 24 * 365)).toBe('next year');
    expect(humanizeRelativeTime(1000 * 60 * 60 * 24 * 365 * 2)).toBe('in 2 years');
  });

  it('should return a humanized duration negative', () => {
    expect(humanizeRelativeTime(-1)).toBe('1 minute ago');
    expect(humanizeRelativeTime(-1000 * 60)).toBe('1 minute ago');
    expect(humanizeRelativeTime(-1000 * 60 - 1)).toBe('2 minutes ago');
    expect(humanizeRelativeTime(-1000 * 60 * 2)).toBe('2 minutes ago');
    expect(humanizeRelativeTime(-1000 * 60 * 2 - 1)).toBe('3 minutes ago');
    ...
    expect(humanizeRelativeTime(-1000 * 60 * 60 * 24 * 30 * 2)).toBe('2 months ago');
    expect(humanizeRelativeTime(-1000 * 60 * 60 * 24 * 30 * 12)).toBe('12 months ago');

    // assume every year has 365 days
    expect(humanizeRelativeTime(-1000 * 60 * 60 * 24 * 365)).toBe('last year');
    expect(humanizeRelativeTime(-1000 * 60 * 60 * 24 * 365 * 2)).toBe('2 years ago');
  });
});

...
describe('getting links to remote (GitHub) locations', () => {
  ...
  it(
    'should return undefined if resolvableLocation has the wrong format',
    () => {
      const loc = {
  ...
  it(
    'should return a remote file ref if the sourceLocationPrefix and resolvableLocation match up',
    () => {
      const loc = {
  ...
  it(
    'should return undefined if the sourceLocationPrefix is missing and resolvableLocation doesn\'t match the default format',
    () => {
      const loc = {
        uri: 'file:/home/foo/bar/path/to/file.ext',
        startLine: 194,
  ...
  it(
    'should return a remote file ref if the sourceLocationPrefix is missing, but the resolvableLocation matches the default format',
    () => {
      const loc = {
